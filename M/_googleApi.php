        ...
        <?php  for($i=0;$i < count($data['items']);++$i)  { 
           ...
           <div> 
                    ...
                    <?php } ?>
                     ...
                     <?php if(isset($jdata['volumeInfo']['title'])) { ?>
                             Titulo: <?php $Titulo=$jdata['volumeInfo']['title'];
                             echo "<input  size='40' type='text' name='cantidad' value=''  > <br>" ;
                             ?>

                    <?php } else { ?> 
                        Titulo: <?php $Titulo=isset($jdata['volumeInfo']['title']);
                             echo "<input style='border:none' type='text' name='cantidad' value=' ' readonly > <br>" ; ?>
                    <?php } ?>
                   
                     <?php echo   "<td><br><input type='submit' id='enviar$i' name='chek' value='Agregar' formaction='añadirALista.php' ></td>"?>
